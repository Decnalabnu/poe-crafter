...
GROUP_KEYWORDS = {
    ...
    "Cold Damage Percentage":      ["increased Cold Damage"],
    "Fire Damage Percentage":      ["increased Fire Damage"],
    "Lightning Damage Percentage": ["increased Lightning Damage"],
    "Increased Chaos Damage":      ["increased Chaos Damage"],
    "Physical Damage Percentage":  ["increased Physical Damage"],
